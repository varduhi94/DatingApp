...
namespace DatingApp2.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateMessage(int userId, MessageForCreatrionDto messageForCreatrionDto)
        {
            ...
            messageForCreatrionDto.SenderId = userId;

            var recipient = await _repo.GetUser(messageForCreatrionDto.RecipientId);

            if(recipient == null)
                return BadRequest("Could not find user");
            
            var message = _mapper.Map<Message>(messageForCreatrionDto);
